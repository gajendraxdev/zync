...
- **File list windowing:** The file manager list view only paints visible rows. Sort lives on FileManager so keyboard order matches the list. Grid view is unchanged for now.
