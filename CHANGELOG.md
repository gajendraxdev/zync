...
### Fixed
- **Exit in a Files split:** Typing `exit` in a shell that is split with Files (or another feature) no longer closes the whole tab. That shell pane closes; the feature stays as the full view.
