...
### Changed
- **Files listing scroll:** Icon view virtualizes after 96 items, skips painting off-screen tiles, and does not re-render on every scroll just to hide an unused hover tip. File icons decode lazily; Places volume lists are cached for 30s.
